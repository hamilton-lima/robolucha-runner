...
public class LuchadorScriptRunner implements Runnable {

	private static Logger logger = Logger.getLogger(LuchadorScriptRunner.class);
	...
	public LuchadorScriptRunner(LuchadorRunner runner, String codeName, Object... parameter) {
