...
public class CheckBulletHitActionTest {
    ...
    public void testRun() throws Exception {
        ...
        ModelGameComponent b = MockLuchador.build(2, MethodNames.ON_REPEAT, "fire(10)");
        ...
        assertEquals("check for damage counter, 1 from fire(1) and 1 from fire(10)",
                2, counter);
        ...
        assertEquals("verifica se lutchador acima do outro recebeu o tiro",
                10.0, runnerA.getState().getLife(), 0.001);
